...
def check_footprint_cl_band_limit(
    ...
    By Parseval, sum_L (2L+1) C_L = 4 pi <map1 map2> for a complete harmonic sum.
    A deficit means the resolution (nside) is too low to capture the footprint
    edges, which biases the mask-dependent sigma2_b used in the SSC.
    """

...
folder_a = f'/home/davide/Documenti/Lavoro/Programmi/CLOE_validation/data/power_spectra/for_SPV3/v2.0.2/NL_flag04/v2_jul24/use_only_flat_modelsTrue/{param_name}'
folder_b = f'/home/davide/Documenti/Lavoro/Programmi/CLOE_validation/data/power_spectra/for_SPV3/v2.0.2/NL_flag04/v1_jan24/{param_name}'
extension = 'dat'

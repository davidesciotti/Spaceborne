...
if which_oc_benc == 'old':
    oc_path = '/export/NAS/cosmo/data/davide.sciotti/data/!archive/Spaceborne_bu/realspace_test'
    ...
    oc_path = '/export/NAS/cosmo/data/davide.sciotti/code/Spaceborne_rs_test/OneCovariance'
